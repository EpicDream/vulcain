...
Order = Struct.new(:product_url, :card_number, :card_crypto, :expire_month, :expire_year, :holder)

user = User.new("Mad", "Max", "madmax_12@yopmail.com", "12 rue des Lilas", "Paris", "75019", Date.parse("1985-10-01"), 0, "0650151515")
...
order = Order.new("http://musique.fnac.com/a5549347/Jean-Louis-Murat-Toboggan-Edition-limitee-CD-album#bl=MUVari%c3%a9t%c3%a9-fran%c3%a7aiseBLO2", "87989898", "345", "01", "2016", "ROGER RABBIT")
context = {user:user, password:USER_ACCOUNT_PASSWORD, order:order}
